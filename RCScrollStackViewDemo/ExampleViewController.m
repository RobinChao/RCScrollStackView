...
@interface ExampleViewController () <UITableViewDataSource,UITableViewDelegate,RCScrollStackViewReorderDelegate> {
	RCScrollStackView		*stackScrollView;
...
- (void)viewDidLoad {
	...
	stackScrollView = [[RCScrollStackView alloc] initWithFrame:UIEdgeInsetsInsetRect(self.view.bounds, UIEdgeInsetsMake(20, 10, 100, 10))];
    stackScrollView.layoutMode = RCScrollStackViewLayoutModelZeroAll;
